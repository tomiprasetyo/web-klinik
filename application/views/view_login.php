                ...
                <div class="card text-center shadow ">
                    ...
                    <div class="card-body">
                        <h2 class="card-title">Terbentuknya Clinic.Web</h5>
                            <p class="card-text py-4">Awal bermulanya terbentuknya clinic dari awal salah satu teman kita yang berkerja di rumah sakit dan mempunyai ide membuat aplikasi web tentang rumah sakit</p>

                            <h2 class="card-title">Penentuan Ide</h5>
                                <p class="card-text py-4">dari beberapa ide kita coba dimulai dari penjadwalan pasien yang kita rangkum dari awal dan kita tanya seperti apa system penjadwalan , tetapi stuck saat pembuatannya karna agak terlalu sulit penerapannya</p>

                                <h2 class="card-title">Gotcha!</h5>
                                    <p class="card-text py-4">dari penjadwalan kita menemukan ide yang lebih tepat , bagaimana kita berperan sebagai admin klinik yang tidak terlalu rumit , dan yang kita buat juga tidak terlalu sulit , tetapi penerapannya sangat efisien</p>
