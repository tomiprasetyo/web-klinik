...
<body>
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1440 320">
        <path fill="#007BFF" fill-opacity="1"
            d="M0,224L80,229.3C160,235,320,245,480,213.3C640,181,800,107,960,90.7C1120,75,1280,117,1360,138.7L1440,160L1440,0L1360,0C1280,0,1120,0,960,0C800,0,640,0,480,0C320,0,160,0,80,0L0,0Z">
        </path>
    </svg>
    <div class="container">
        <!-- start navbar -->
            ...
            <div class="col-8">
                <nav id="navbar-judule" class="navbar navbar-light ">
                    <ul class="nav nav-pills">
                        <li class="nav-item">
                            <a class="nav-link text-muted" href="#home"><svg xmlns="http://www.w3.org/2000/svg"
                                    width="18" fill="currentColor" class="bi bi-house" viewBox="0 0 16 16">
                        ...
                        <li class="nav-item">
                            <a class="nav-link text-muted" href="#tentang"><svg xmlns="http://www.w3.org/2000/svg"
                                    width="18" fill="currentColor" class="bi bi-app-indicator" viewBox="0 0 16 16">
                                    <path
        ...
        <!-- start navbar -->
        <div data-bs-spy="scroll" data-bs-target="#navbar-judule" data-bs-offset="0" class="scrollspy-example"
            tabindex="0">
            ...
            <div class="ini_login row pt-4" id="home">
                ...
                <div class="col py-4 mx-auto">
                    <form method="POST" action="<?= base_url("auth/login_aksi"); ?>">
                        ...
                        <div data-aos="fade-up-left" class="input-group shadow p-3 mb-5"
                            ...
                            <input type="text" id="username" name="username" style="border: none;" class="border-0"
                                placeholder="username" autofocus>
                        </div>
                        <!-- inputpass -->
                        <div data-aos="fade-up-left" class="input-group py-3 shadow p-3 mb-5"
                            style="width:400px; border-radius: 15px;">
                            <div class="input-group-prepend">
                                <span class="input-group-text border-0 bg-transparent pr-4" id="basic-addon1">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                            ...
                            <input type="password" id="password" name="password" style="border: none;" class="border-0"
                                placeholder="password">
                        </div>
                        <!-- inputpass -->
                        <div data-aos="fade-up">
                            <button class="btn btn-lg border-success text-success shadow " style="border-radius: 10px;"
            ...
            <div data-aos="flip-up" class="ini_tentang tentang pt-5" id="tentang">
                <div class="card text-center shadow ">
                    <div class="card-header">
                        <svg xmlns="http://www.w3.org/2000/svg" width="50" fill="currentColor" class="bi bi-lightbulb"
                            viewBox="0 0 16 16">
                            <path
            ...
            <div class="ini_kontak kontak pt-5" id="kontak">
                <div class="container px-auto">
                    ...
                    <div class="row">
                        ...
                        <div class="col">
                            <div data-aos="fade-down" class="card text-center border-danger"
                        ...
                        <div class="col">
                            <div data-aos="fade-down" class="card text-center border-success"
                                style="border-radius: 40px;">
                                <div class="azis text-center">
    ...
    <div class="footer text-center">
        <p class="mt-5 mb-3 text-muted">&copy; 2021 - <a class="text-muted"
                href="https://github.com/tomiprasetyo/web-klinik">Kelompok 1</a></p>
    </div>
